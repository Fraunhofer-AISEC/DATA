...
# $1 ... key file name
function cb_genkey {
  ${BINARY} keygen --algo=${ALGO} --params=${PARAM} > "$1"
  RES=$((RES + $?))
}
...
#   ${BINARY} keygen --algo=${ALGO} --params=${PARAM} > static.key
#   echo "-----BEGIN PRIVATE KEY-----
# MHACAQAwFAYHKoZIzj0CAQYJKyQDAwIIAQEDBFUwUwIBAQQYgI65v9ekZ52wFCBB
# mkEh438fE/ZznC5NoTQDMgAEbDFsJx0BRmz14NKpz7LUyskxdhD0ndaKvbaHeU8r
# S+VwHHPerR2Sbs2HiRfZ1gU5
# -----END PRIVATE KEY-----" > static.key
